...
/*******************************/
unsigned char p2_tri_f_f_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
FILE* fid;
char filename[256];	
unsigned char bin=0;
...
sprintf(filename,"%s/p_tri_f_f_s_%llu_%d.txt",dirname,Q,N);
fid = fopen(filename,"w");
if (fid == NULL)
{
	printf("\nERROR: Could not create output file. %s\n",strerror(errno));
...
/*******************************/
unsigned char p2_tri_c_f_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
FILE* fid;
char filename[256];	
unsigned char bin=0;
...
sprintf(filename,"%s/p_tri_c_f_s_%llu_%d.txt",dirname,Q,N);
fid = fopen(filename,"w");
if (fid == NULL)
{
	printf("\nERROR: Could not create output file. %s\n",strerror(errno));
...
/*******************************/
unsigned char pf2_tri_f_f_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
FILE* fid;
char filename[256];	
unsigned char bin=0;
...
sprintf(filename,"%s/pf_tri_f_f_s_%llu_%d.txt",dirname,Q,N);
fid = fopen(filename,"w");
if (fid == NULL)
{
	printf("\nERROR: Could not create output file. %s\n",strerror(errno));
...
/*******************************/
unsigned char pf2_tri_c_f_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
FILE* fid;
char filename[256];	
unsigned char bin=0;
...
sprintf(filename,"%s/pf_tri_c_f_s_%llu_%d.txt",dirname,Q,N);
fid = fopen(filename,"w");
if (fid == NULL)
{
	printf("\nERROR: Could not create output file. %s\n",strerror(errno));
...
/*******************************/
unsigned char p_tri_f_f_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
const unsigned char csize=CHAR_BIT;
FILE* fid;
char filename[256];	
...
/*******************************/
unsigned char p_tri_c_f_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
const unsigned char csize=CHAR_BIT;
FILE* fid;
char filename[256];	
...
/*******************************/
unsigned char pf_tri_f_f_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
const unsigned char csize=CHAR_BIT;
FILE* fid;
char filename[256];	
...
/*******************************/
unsigned char pf_tri_c_f_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
const unsigned char csize=CHAR_BIT;
FILE* fid;
char filename[256];	
