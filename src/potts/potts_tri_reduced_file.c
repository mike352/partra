...
/*******************************/
unsigned char p2_tri_f_r_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
...
/*******************************/
unsigned char p2_tri_c_r_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
  printf("This function is not implemented yet.\n");
// unsigned char umax = 3*N;
// 
...
/*******************************/
unsigned char pf2_tri_f_r_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
  printf("This function is not implemented yet.\n");
// char option[256];
// printf("\nThe full transfer matrix for free row boundary conditions does not have a direct sum in terms of parity sectors. Therefore the reduced transfer matrix is not a valid reflection symmetric sector. Continue anyway? (y,n): ");
...
/*******************************/
unsigned char pf2_tri_c_r_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
  printf("This function is not implemented yet.\n");
// unsigned char umax = 3*N;
// unsigned char xmax = N;
...
/*******************************/
unsigned char p_tri_f_r_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
  printf("This function is not implemented yet.\n");
// char option[256];
// printf("\nThe full transfer matrix for free row boundary conditions does not have a direct sum in terms of parity sectors. Therefore the reduced transfer matrix is not a valid reflection symmetric sector. Continue anyway? (y,n): ");
...
/*******************************/
unsigned char p_tri_c_r_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
  printf("This function is not implemented yet.\n");
// unsigned char umax = 3*N;
// 
...
/*******************************/
unsigned char pf_tri_f_r_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
  printf("This function is not implemented yet.\n");
// char option[256];
// printf("\nThe full transfer matrix for free row boundary conditions does not have a direct sum in terms of parity sectors. Therefore the reduced transfer matrix is not a valid reflection symmetric sector. Continue anyway? (y,n): ");
...
/*******************************/
unsigned char pf_tri_c_r_s_file(const unsigned char N, const unsigned long long Q, const char* dirname)
{
  printf("This function is not implemented yet.\n");
// unsigned char umax = 3*N;
// unsigned char xmax = N;
