...
/***********************************************/
/*******************************/
unsigned char i_sq_f_f_s_file(const unsigned char N, const char* dirname)
{
unsigned long long n;
unsigned long long m;
FILE *fid;
...
/*******************************/
unsigned char i_sq_c_f_s_file(const unsigned char N, const char* dirname)
{
unsigned long long n;
unsigned long long m;
FILE *fid;
...
/*******************************/
unsigned char if_sq_f_f_s_file(const unsigned char N, const char* dirname)
{
unsigned long long n;
unsigned long long m;
FILE *fid;
...
/*******************************/
unsigned char if_sq_c_f_s_file(const unsigned char N, const char* dirname)
{
unsigned long long n;
unsigned long long m;
FILE *fid;
